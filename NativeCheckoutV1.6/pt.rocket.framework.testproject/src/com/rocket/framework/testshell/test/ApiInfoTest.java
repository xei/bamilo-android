...
public class ApiInfoTest extends FrameworkServiceTests {
    ...
    public void testGetApiInfoIC() throws Throwable {
        ...
        args.putString(BaseHelper.KEY_COUNTRY, "http://www.jumia.ci/mobapi/main/md5?setDevice=mobileApi");
    ...
    public void testGetApiInfoKE() throws Throwable {
        Log.i(TAG, "mService => " + mService);
        final Bundle args = new Bundle();
        args.putString(BaseHelper.KEY_COUNTRY, "http://www.jumia.co.ke/mobapi/main/md5?setDevice=mobileApi");
    ...
    public void testGetApiInfoMA() throws Throwable {
        Log.i(TAG, "mService => " + mService);
        final Bundle args = new Bundle();
        args.putString(BaseHelper.KEY_COUNTRY, "http://www.jumia.ma/mobapi/main/md5?setDevice=mobileApi");
    ...
    public void testGetApiInfoNG() throws Throwable {
        Log.i(TAG, "mService => " + mService);
        final Bundle args = new Bundle();
        args.putString(BaseHelper.KEY_COUNTRY, "http://www.jumia.com.ng/mobapi/main/md5?setDevice=mobileApi");
    ...
    public void testGetApiInfoEG() throws Throwable {
        Log.i(TAG, "mService => " + mService);
        final Bundle args = new Bundle();
        args.putString(BaseHelper.KEY_COUNTRY, "https://www.jumia.com.eg/mobapi/main/md5?setDevice=mobileApi");
    ...
    public void testGetApiInfoUG() throws Throwable {
        Log.i(TAG, "mService => " + mService);
        final Bundle args = new Bundle();
        args.putString(BaseHelper.KEY_COUNTRY, "https://www.jumia.ug/mobapi/main/md5?setDevice=mobileApi");
