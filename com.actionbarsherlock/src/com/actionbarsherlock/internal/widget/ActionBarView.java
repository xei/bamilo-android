...
public class ActionBarView extends AbsActionBarView {
	...
	/**
	 * JUMIA MODIFICATION Verify if the view was animated if so, perform the
	 * other animation
	 */
	...
	public void animateUpButton(boolean open) {
		if (open) {
			int end = mUpView.getWidth() / 3;
			int slice = end / 5;
			Message msg1 = new Message();
			msg1.arg1 = end - slice;
			msg1.arg2 = 0;
			mAnimationHandler.sendMessageDelayed(msg1, 0);
			Message msg2 = new Message();
			msg2.arg1 = end - (slice*2);
			msg2.arg2 = 0;
			mAnimationHandler.sendMessageDelayed(msg2, 50);
			Message msg3 = new Message();
			msg3.arg1 = end - (slice*3);
			msg3.arg2 = 0;
			mAnimationHandler.sendMessageDelayed(msg3, 100);
			Message msg4 = new Message();
			msg4.arg1 = end - (slice*4);
			msg4.arg2 = 0;
			mAnimationHandler.sendMessageDelayed(msg4, 150);
			Message msg5 = new Message();
			msg5.arg1 = 0;
			msg5.arg2 = 0;
			mAnimationHandler.sendMessageDelayed(msg5, 200);
	...
	Handler mAnimationHandler = new Handler(){
		public void handleMessage(android.os.Message msg) {
			mUpView.scrollTo(msg.arg1, msg.arg2);
		};
	};
	...
	public ActionBarView(Context context, AttributeSet attrs) {
		...
		/**
		 * Jumia Changes
		 * Get Up View to animate when clicked.
		 */
		mUpView = mHomeLayout.getUpView();
