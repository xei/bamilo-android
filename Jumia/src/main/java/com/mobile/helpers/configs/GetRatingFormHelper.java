 ...
 * 
 */
public class GetRatingFormHelper extends BaseHelper {

    private static String TAG = GetRatingFormHelper.class.getSimpleName();
    
    private static final EventType EVENT_TYPE = EventType.GET_FORM_RATING_EVENT;
    ...
    public Bundle generateRequestBundle(Bundle args) {
        ...
        bundle.putString(Constants.BUNDLE_URL_KEY, EventType.GET_FORM_RATING_EVENT.action);
        bundle.putBoolean(Constants.BUNDLE_PRIORITY_KEY, HelperPriorityConfiguration.IS_PRIORITARY);
        bundle.putSerializable(Constants.BUNDLE_TYPE_KEY, RequestType.GET);
        bundle.putString(Constants.BUNDLE_MD5_KEY, Utils.uniqueMD5(EVENT_TYPE.name()));
        bundle.putSerializable(Constants.BUNDLE_EVENT_TYPE_KEY, EventType.GET_FORM_RATING_EVENT);
        return bundle;
    }
