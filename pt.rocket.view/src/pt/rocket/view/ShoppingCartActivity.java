 ...
 * Proprietary and confidential. Written by josedourado, 19/06/2012.
 * </p>
 * 
 * 
 * 
...
public class ShoppingCartActivity extends MyActivity implements OnItemClickListener {
	...
	private void goToProducDetails(int position) {
		...
		ActivitiesWorkFlow.productsDetailsActivity(this, items.get(position).getProductUrl(), R.string.gcart_prefix, "");
	}
