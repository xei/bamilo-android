...
public class HomeFragment extends BaseFragment {
 ...
 //   private int defaultPosition=Math.abs(requestResponse.size() / 2);
	 ...
	 */
    public HomeFragment() {
        super( EnumSet.of(EventType.GET_API_INFO, EventType.GET_TEASERS_EVENT, EventType.GET_CALL_TO_ORDER_PHONE, EventType.GET_PROMOTIONS, EventType.GET_NAVIGATION_LIST_COMPONENTS_EVENT),
    ...
    protected boolean onSuccessEvent(ResponseResultEvent<?> event) {
        ...
        case GET_PROMOTIONS:
            if(((Promotion) event.result).getIsStillValid()){
                DialogPromotionFragment.newInstance((Promotion) event.result).show(getChildFragmentManager(), null);    
            } else {
...
//            fragmentBrandsListTeaser = null;
            ...
            for (Iterator iterator = result.iterator(); iterator.hasNext();) {
                ...
                case MAIN_ONE_SLIDE:
                    ...
                    if (((ImageTeaserGroup) teaserSpecification).getTeasers().size() > 0) {
                        ...
                        fragmentManagerChildTransition(R.id.main_one_frame, fragmentMainOneSlide, false,
                                false);
                    }
                    break;
                case STATIC_BANNER:
                    ...
                    fragmentManagerChildTransition(R.id.static_teaser_frame, fragmentStaticBanner,
                            false, false);
                    break;
                case CATEGORIES:
                    ...
                    fragmentManagerChildTransition(R.id.content_frame, fragmentCategoryTeaser, false,
                            false);
                    break;
                case PRODUCT_LIST:
                    ...
                    fragmentManagerChildTransition(R.id.products_list_frame, fragmentProductListTeaser,
                            false, false);
                    break;
                case BRANDS_LIST:
                    ...
                    fragmentManagerChildTransition(R.id.brands_list_frame, fragmentBrandsListTeaser,
                            false, false);
                    break;
                }
            }
        ...
        protected void fragmentManagerChildTransition(int container, Fragment fragment,
