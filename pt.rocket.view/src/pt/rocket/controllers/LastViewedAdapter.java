...
public class LastViewedAdapter extends PagerAdapter {
    ...
    public int getCount() {
        ...
        if (mLastViewedList.size() == 0) {
            count = 0;
        } else if (mLastViewedList.size() / this.partialSize == 0
                || (mLastViewedList.size() / this.partialSize == 1 && mLastViewedList.size()
                        % this.partialSize == 0)) {
            count = 1;
        } else if (mLastViewedList.size() / this.partialSize == 1
                || (mLastViewedList.size() / this.partialSize == 2 && mLastViewedList.size()
                        % this.partialSize == 0)) {
            count = 2;
        } else if (mLastViewedList.size() / this.partialSize == 2
                || (mLastViewedList.size() / this.partialSize == 3 && mLastViewedList.size()
                        % this.partialSize == 0)) {
            count = 3;
        } else if (mLastViewedList.size() / this.partialSize == 3
                || (mLastViewedList.size() / this.partialSize == 4 && mLastViewedList.size()
                        % this.partialSize == 0)) {
            count = 4;
        } else if (mLastViewedList.size() / this.partialSize >= 4) {
            count = 5;
        }
        return count;
    }
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        if (position * 3 < this.mLastViewedList.size()) {
            ...
            mElement1.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString(ConstantsIntentExtra.CONTENT_URL,
                            mLastViewedList.get(position * 3).getProductUrl());
            ...
            aq.id(img_1).image(mLastViewedList.get(position * 3).getImageUrl(), true, true, 0, 0,
        ...
        if ((position * 3 + 1) < this.mLastViewedList.size()) {
            ...
            mElement2.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    Bundle bundle = new Bundle();
                    bundle.putString(ConstantsIntentExtra.CONTENT_URL,
                            mLastViewedList.get(position * 3 + 1).getProductUrl());
                    bundle.putInt(ConstantsIntentExtra.NAVIGATION_SOURCE,
            ...
            aq.id(img_2).image(mLastViewedList.get(position * 3 + 1).getImageUrl(), true, true, 0,
        ...
        if ((position * 3 + 2) < this.mLastViewedList.size()) {
            ...
            mElement3.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    Bundle bundle = new Bundle();
                    bundle.putString(ConstantsIntentExtra.CONTENT_URL,
                            mLastViewedList.get(position * 3 + 2).getProductUrl());
                    bundle.putInt(ConstantsIntentExtra.NAVIGATION_SOURCE,
                            R.string.gteaserprod_prefix);
                    bundle.putString(ConstantsIntentExtra.NAVIGATION_PATH, "");
                    ((BaseActivity) mContext).onSwitchFragment(
            ...
            aq.id(img_3).image(mLastViewedList.get(position * 3 + 2).getImageUrl(), true, true, 0,
                    0, new BitmapAjaxCallback() {
        ...
        if (partialSize > 3) {
            if ((position * 3 + 3) < this.mLastViewedList.size()) {
                ...
                mElement4.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Bundle bundle = new Bundle();
                        bundle.putString(ConstantsIntentExtra.CONTENT_URL,
                                mLastViewedList.get(position * 3 + 3).getProductUrl());
                        bundle.putInt(ConstantsIntentExtra.NAVIGATION_SOURCE,
                                R.string.gteaserprod_prefix);
                        bundle.putString(ConstantsIntentExtra.NAVIGATION_PATH, "");
                        ((BaseActivity) mContext).onSwitchFragment(
                ...
                name_4.setText(mLastViewedList.get(position * 3 + 3).getProductName());
                price_4.setText(mLastViewedList.get(position * 3 + 3).getProductPrice());
                AQuery aq = new AQuery(mContext);

                aq.id(img_4).image(mLastViewedList.get(position * 3 + 3).getImageUrl(), true, true,
            ...
            if ((position * 3 + 4) < this.mLastViewedList.size()) {
                ...
                mElement5.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Bundle bundle = new Bundle();
                        bundle.putString(ConstantsIntentExtra.CONTENT_URL,
                                mLastViewedList.get(position * 3 + 4).getProductUrl());
                        bundle.putInt(ConstantsIntentExtra.NAVIGATION_SOURCE,
                                R.string.gteaserprod_prefix);
                        bundle.putString(ConstantsIntentExtra.NAVIGATION_PATH, "");
                        ((BaseActivity) mContext).onSwitchFragment(
                ...
                // Log.i(TAG,
                // "code1last generating : "+mLastViewedList.get(position).getProductName());
                name_5.setText(mLastViewedList.get(position * 3 + 4).getProductName());
                price_5.setText(mLastViewedList.get(position * 3 + 4).getProductPrice());
                AQuery aq = new AQuery(mContext);

                aq.id(img_5).image(mLastViewedList.get(position * 3 + 4).getImageUrl(), true, true,
                        0, 0, new BitmapAjaxCallback() {
