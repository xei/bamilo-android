...
//        currMapping.put("is_terms_accepted", 121);
...
//        	android.util.Log.e("REMOVE FIELD KEY", ":"+field.getKey());
...
//        	android.util.Log.e("GET VALIDATION BOOLEAN", ":"+field.getValidation().required);
//        	android.util.Log.e("GET VALIDATION CONTAINS", ":"+fieldMap.containsKey(field.getKey()));
            if (!field.getValidation().required && !fieldMap.containsKey(field.getKey())) {
            	fieldsToRemove.add(field);
//            	android.util.Log.e("REMOVE FIELD KEY ADDED", ":"+field.getKey());
            	continue;
            }
...
//        	android.util.Log.e( TAG, "removeUnsortedFields: removing field: " + field.getKey() );
