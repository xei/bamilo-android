...
//	private static final String JSON_SEMIREQUIRED_TAG = "semiRequired";
...
//    private static final String JSON_INTEGER_ONLY_TAG = "integerOnly";
	...
	public boolean initialize(JSONObject jsonObject) {
		...
		required = jsonObject.optBoolean(RestConstants.JSON_REQUIRED_TAG, false);
			 semiRequired = jsonObject.optBoolean(RestConstants.JSON_SEMIREQUIRED_TAG, false);

		if(!required){
		    required = jsonObject.optBoolean(RestConstants.JSON_SEMIREQUIRED_TAG, false);
		}
        ...
        integerOnly = jsonObject.optBoolean(RestConstants.JSON_INTEGER_ONLY_TAG,false);
	...
	/**
	 * @return if the field is semiRequired.
	 */
	public boolean isSemiRequired() {
		return semiRequired;
	}
	...
	public JSONObject toJSON() {
		...
		try {
			jsonObject.put(RestConstants.JSON_SEMIREQUIRED_TAG, semiRequired);
