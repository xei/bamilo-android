 ...
 *
 */
public class FilterSizeFragment extends Fragment implements OnClickListener, OnItemClickListener{
    ...
    private CatalogFilter mSizeFilter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSizeFilter = bundle.getParcelable(DialogFilterFragment.FILTER_TAG);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if(mSizeFilter.hasOptionSelected()){
            mSelectedOptionPos = mSizeFilter.getSelectedOption();
            mSizeFilter.getFilterOptions().get(mSelectedOptionPos).setSelected(true);
        }
        // Title
        ((TextView) view.findViewById(R.id.dialog_filter_header_title)).setText(mSizeFilter.getName());
        // Back button
        ...
        mOptionArray = new FilterOptionArrayAdapter(getActivity(), mSizeFilter.getFilterOptions());
    ...
    public void onClick(View view) {
        ...
        if(id == mBackButtonId || id == mCancelButtonId) {
            ...
            if(mSelectedOptionPos != -1) mSizeFilter.getFilterOptions().get(mSelectedOptionPos).setSelected(false);
            // Go to back
            ...
            if(mSelectedOptionPos != -1){
                mSizeFilter.getFilterOptions().get(mSelectedOptionPos).setSelected(false);
            ...
            if(mSelectedOptionPos != -1) mSizeFilter.setSelectedOption(mSelectedOptionPos);
            else mSizeFilter.cleanSelectedOption();
            // Goto back
            mParent.allowBackPressed();
        }
    }
