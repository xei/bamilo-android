...
public class GetPaymentMethodsHelper extends BaseHelper {
    ...
    public Bundle generateRequestBundle(Bundle args) {
        ...
        bundle.putString(Constants.BUNDLE_URL_KEY, EventType.GET_PAYMENT_METHODS_EVENT.action);
        bundle.putSerializable(Constants.BUNDLE_TYPE_KEY, RequestType.POST);
        bundle.putBoolean(Constants.BUNDLE_PRIORITY_KEY, HelperPriorityConfiguration.IS_PRIORITARY);
        bundle.putSerializable(Constants.BUNDLE_EVENT_TYPE_KEY, EventType.GET_PAYMENT_METHODS_EVENT);
