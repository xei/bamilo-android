 ...
 * 
 */
public class GetInnerCategoriesHelper extends BaseHelper {
    
    private static String TAG = GetInnerCategoriesHelper.class.getSimpleName();
    ...
    public Bundle parseResponseBundle(Bundle bundle, JSONObject jsonObject) {
        try {// TODO add further object parsing possibilities : for example data
        	...
        	android.util.Log.d("TRACK", "parseResponseBundle GetInnerCategoriesHelper");
            ...
            bundle.putString(Constants.BUNDLE_URL_KEY, " GetInnerCategoriesHelper");
    ...
    public Bundle parseErrorBundle(Bundle bundle) {
    	...
    	android.util.Log.d("TRACK", "parseErrorBundle GetInnerCategoriesHelper");
        //FIXME next line is just for test porpouse, to delete
        bundle.putString(Constants.BUNDLE_URL_KEY, " GetInnerCategoriesHelper");
        return bundle;
    }
