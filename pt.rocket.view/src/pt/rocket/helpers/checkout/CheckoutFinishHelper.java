...
public class CheckoutFinishHelper extends BaseHelper {
    ...
    public Bundle parseResponseBundle(Bundle bundle, JSONObject jsonObject) {
        ...
        try {
            ...
            // WALLETY  {"form":{"action":"https:\/\/www.wallety.com\/checkout\/checkout","id":"Wallety","method":"post","fields":[{"id":"amount","value":"4199.00","label":"","type":"hidden","rules":null,"key":"amount","name":"amount"},{"id":"desc","value":"Purchase -","label":"","type":"hidden","rules":null,"key":"desc","name":"desc"},{"id":"gid","value":"84","label":"","type":"hidden","rules":null,"key":"gid","name":"gid"},{"id":"merchinvno","value":"300088712","label":"","type":"hidden","rules":null,"key":"merchinvno","name":"merchinvno"},{"id":"redirect","value":"https:\/\/alice-staging.jumia.co.ke\/checkout\/wallety\/success","label":"","type":"hidden","rules":null,"key":"redirect","name":"redirect"},{"id":"check_sum","value":"BEAD6204A74BFAB15BCDD3B77CF15096","label":"","type":"hidden","rules":null,"key":"check_sum","name":"check_sum"},{"id":"checkout","value":"","label":"","type":"image","rules":null,"key":"checkout","name":"checkout"}],"name":"Wallety"},"type":"submit-external","method":"post"}
            // AAIB     {"form":{"action":null,"id":"AAIB","method":"get","fields":[{"id":"vpc_AVS_City","value":"","label":"","rules":null,"key":"vpc_AVS_City","name":"vpc_AVS_City"},{"id":"vpc_AVS_Country","value":"","label":"","rules":null,"key":"vpc_AVS_Country","name":"vpc_AVS_Country"},{"id":"vpc_AVS_StateProv","value":"","label":"","rules":null,"key":"vpc_AVS_StateProv","name":"vpc_AVS_StateProv"},{"id":"vpc_AVS_Street01","value":"","label":"","rules":null,"key":"vpc_AVS_Street01","name":"vpc_AVS_Street01"},{"id":"vpc_AccessCode","value":"","label":"","rules":null,"key":"vpc_AccessCode","name":"vpc_AccessCode"},{"id":"vpc_Amount","value":"","label":"","rules":null,"key":"vpc_Amount","name":"vpc_Amount"},{"id":"vpc_Command","value":"","label":"","rules":null,"key":"vpc_Command","name":"vpc_Command"},{"id":"vpc_Currency","value":"","label":"","rules":null,"key":"vpc_Currency","name":"vpc_Currency"},{"id":"vpc_Locale","value":"","label":"","rules":null,"key":"vpc_Locale","name":"vpc_Locale"},{"id":"vpc_MerchTxnRef","value":"","label":"","rules":null,"key":"vpc_MerchTxnRef","name":"vpc_MerchTxnRef"},{"id":"vpc_Merchant","value":"","label":"","rules":null,"key":"vpc_Merchant","name":"vpc_Merchant"},{"id":"vpc_OrderInfo","value":"","label":"","rules":null,"key":"vpc_OrderInfo","name":"vpc_OrderInfo"},{"id":"vpc_ReturnURL","value":"","label":"","rules":null,"key":"vpc_ReturnURL","name":"vpc_ReturnURL"},{"id":"vpc_Version","value":"","label":"","rules":null,"key":"vpc_Version","name":"vpc_Version"},{"id":"vpc_SecureHash","value":"","label":"","rules":null,"key":"vpc_SecureHash","name":"vpc_SecureHash"}],"name":"AAIB"},"type":"auto-redirect-external","method":"post"}
            // GLOBALPAY{"form":{"action":"https:\/\/41.203.113.80\/globalpay_demo\/paymentgatewaycapture.aspx","id":"GlobalPay","method":"post","fields":[{"id":"names","value":"mob nsme mob last","label":"","type":"hidden","rules":null,"key":"names","name":"names"},{"id":"merchantid","value":"gfd","label":"","type":"hidden","rules":null,"key":"merchantid","name":"merchantid"},{"id":"currency","value":"NGN","label":"","type":"hidden","rules":null,"key":"currency","name":"currency"},{"id":"amount","value":"4199.00","label":"","type":"hidden","rules":["1"],"key":"amount","name":"amount"},{"id":"email_address","value":"test02@jumia.com","label":"","type":"hidden","rules":null,"key":"email_address","name":"email_address"},{"id":"phone_number","value":"123456789","label":"","type":"hidden","rules":null,"key":"phone_number","name":"phone_number"},{"id":"merch_txnref","value":"300078712","label":"","type":"hidden","rules":null,"key":"merch_txnref","name":"merch_txnref"}],"name":"GlobalPay"},"type":"auto-submit-external","method":"post"}
            // YUCASH   {"form":{"action":"https:\/\/ipay.intrepid.co.ke\/incoming\/","id":"iPay_yuCash","method":"post","fields":[{"id":"order_id","value":"300058712","label":"","type":"hidden","rules":null,"key":"order_id","name":"order_id"},{"id":"invoice","value":"","label":"","type":"hidden","rules":null,"key":"invoice","name":"invoice"},{"id":"total","value":57999,"label":"","type":"hidden","rules":null,"key":"total","name":"total"},{"id":"phone1","value":"123456789","label":"","type":"hidden","rules":null,"key":"phone1","name":"phone1"},{"id":"email","value":"msilva@jumia.com","label":"E-Mail","type":"email","rules":{"required":true,"min":5,"regex":"[a-zA-Z0-9äöüÄÖÜ_+.-]+@[a-zA-Z0-9äöüÄÖÜ][a-zA-Z0-9-äöüÄÖÜ.]+\\.([a-zA-Z]{2,6})","max":70},"key":"email","name":"email"},{"id":"vendor_ref","value":"jumiatest","label":"","type":"hidden","rules":null,"key":"vendor_ref","name":"vendor_ref"},{"id":"p1","value":"DE168ELAA562NAFAMZ-7554","label":"","type":"hidden","rules":null,"key":"p1","name":"p1"},{"id":"p2","value":"57999.00","label":"","type":"hidden","rules":null,"key":"p2","name":"p2"},{"id":"merchant","value":"Jumia Kenya","label":"","type":"hidden","rules":null,"key":"merchant","name":"merchant"},{"id":"callback","value":"https:\/\/alice-staging.jumia.co.ke\/checkout\/ipay\/confirm\/","label":"","type":"hidden","rules":null,"key":"callback","name":"callback"},{"id":"custemail","value":"","label":"","type":"hidden","rules":null,"key":"custemail","name":"custemail"},{"id":"tc","value":"","label":"I accept the Terms & Agreements","type":"checkbox","rules":{"required":{"message":"Required field","requiredValue":true}},"key":"tc","name":"tc"},{"id":"hashid","value":"","label":"","type":"hidden","rules":null,"key":"hashid","name":"hashid"},{"id":"yu","value":"","label":"yuCash Transaction ID","type":"text","rules":{"required":true},"key":"yu","name":"yu"}],"name":"iPay_yuCash"},"type":"submit-external","method":"post"}
            // AIRTEL_M {"form":{"action":"https:\/\/ipay.intrepid.co.ke\/incoming\/","id":"iPay_Airtel_Money","method":"post","fields":[{"id":"order_id","value":"300018712","label":"","type":"hidden","rules":null,"key":"order_id","name":"order_id"},{"id":"invoice","value":"","label":"","type":"hidden","rules":null,"key":"invoice","name":"invoice"},{"id":"total","value":57999,"label":"","type":"hidden","rules":null,"key":"total","name":"total"},{"id":"phone1","value":"123456789","label":"","type":"hidden","rules":null,"key":"phone1","name":"phone1"},{"id":"email","value":"msilva@jumia.com","label":"E-Mail","type":"email","rules":{"required":true,"min":5,"regex":"[a-zA-Z0-9äöüÄÖÜ_+.-]+@[a-zA-Z0-9äöüÄÖÜ][a-zA-Z0-9-äöüÄÖÜ.]+\\.([a-zA-Z]{2,6})","max":70},"key":"email","name":"email"},{"id":"vendor_ref","value":"jumiatest","label":"","type":"hidden","rules":null,"key":"vendor_ref","name":"vendor_ref"},{"id":"p1","value":"DE168ELAA562NAFAMZ-7554","label":"","type":"hidden","rules":null,"key":"p1","name":"p1"},{"id":"p2","value":"57999.00","label":"","type":"hidden","rules":null,"key":"p2","name":"p2"},{"id":"merchant","value":"Jumia Kenya","label":"","type":"hidden","rules":null,"key":"merchant","name":"merchant"},{"id":"callback","value":"https:\/\/alice-staging.jumia.co.ke\/checkout\/ipay\/confirm\/","label":"","type":"hidden","rules":null,"key":"callback","name":"callback"},{"id":"custemail","value":"","label":"","type":"hidden","rules":null,"key":"custemail","name":"custemail"},{"id":"tc","value":"","label":"I accept the Terms & Agreements","type":"checkbox","rules":{"required":{"message":"Required field","requiredValue":true}},"key":"tc","name":"tc"},{"id":"hashid","value":"","label":"","type":"hidden","rules":null,"key":"hashid","name":"hashid"},{"id":"zap","value":"","label":"Airtel Money Transaction ID","type":"text","rules":{"required":true},"key":"zap","name":"zap"}],"name":"iPay_Airtel_Money"},"type":"submit-external","method":"post"}
            // MI_CARDS {"form":{"action":"https:\/\/ipay.intrepid.co.ke\/inm\/","id":"iPay_MI_Cards","method":"post","fields":[{"id":"order_id","value":"300047712","label":"","type":"hidden","rules":null,"key":"order_id","name":"order_id"},{"id":"invoice","value":"","label":"","type":"hidden","rules":null,"key":"invoice","name":"invoice"},{"id":"total","value":57999,"label":"","type":"hidden","rules":null,"key":"total","name":"total"},{"id":"phone1","value":"123456789","label":"","type":"hidden","rules":null,"key":"phone1","name":"phone1"},{"id":"email","value":"msilva@jumia.com","label":"E-Mail","type":"email","rules":{"required":true,"min":5,"regex":"[a-zA-Z0-9äöüÄÖÜ_+.-]+@[a-zA-Z0-9äöüÄÖÜ][a-zA-Z0-9-äöüÄÖÜ.]+\\.([a-zA-Z]{2,6})","max":70},"key":"email","name":"email"},{"id":"vendor_ref","value":"jumiatest","label":"","type":"hidden","rules":null,"key":"vendor_ref","name":"vendor_ref"},{"id":"p1","value":"DE168ELAA562NAFAMZ-7554","label":"","type":"hidden","rules":null,"key":"p1","name":"p1"},{"id":"p2","value":"57999.00","label":"","type":"hidden","rules":null,"key":"p2","name":"p2"},{"id":"merchant","value":"Jumia Kenya","label":"","type":"hidden","rules":null,"key":"merchant","name":"merchant"},{"id":"callback","value":"https:\/\/alice-staging.jumia.co.ke\/checkout\/ipay\/confirm\/","label":"","type":"hidden","rules":null,"key":"callback","name":"callback"},{"id":"custemail","value":"","label":"","type":"hidden","rules":null,"key":"custemail","name":"custemail"},{"id":"tc","value":"","label":"I accept the Terms & Agreements","type":"checkbox","rules":{"required":{"message":"Required field","requiredValue":true}},"key":"tc","name":"tc"},{"id":"hashid","value":"9651fc7360b1a88547ee219bffc7f2b099118cf6","label":"","type":"hidden","rules":null,"key":"hashid","name":"hashid"},{"id":"cur","value":"KES","label":"","type":"hidden","rules":null,"key":"cur","name":"cur"}],"name":"iPay_MI_Cards"},"type":"submit-external","method":"post"}
            // M-PESA   {"form":{"action":"https:\/\/ipay.intrepid.co.ke\/incoming\/","id":"iPay_M-PESA","method":"post","fields":[{"id":"order_id","value":"300067712","label":"","type":"hidden","rules":null,"key":"order_id","name":"order_id"},{"id":"invoice","value":"","label":"","type":"hidden","rules":null,"key":"invoice","name":"invoice"},{"id":"total","value":57999,"label":"","type":"hidden","rules":null,"key":"total","name":"total"},{"id":"phone1","value":"123456789","label":"","type":"hidden","rules":null,"key":"phone1","name":"phone1"},{"id":"email","value":"msilva@jumia.com","label":"E-Mail","type":"email","rules":{"required":true,"min":5,"regex":"[a-zA-Z0-9äöüÄÖÜ_+.-]+@[a-zA-Z0-9äöüÄÖÜ][a-zA-Z0-9-äöüÄÖÜ.]+\\.([a-zA-Z]{2,6})","max":70},"key":"email","name":"email"},{"id":"vendor_ref","value":"jumiatest","label":"","type":"hidden","rules":null,"key":"vendor_ref","name":"vendor_ref"},{"id":"p1","value":"DE168ELAA562NAFAMZ-7554","label":"","type":"hidden","rules":null,"key":"p1","name":"p1"},{"id":"p2","value":"57999.00","label":"","type":"hidden","rules":null,"key":"p2","name":"p2"},{"id":"merchant","value":"Jumia Kenya","label":"","type":"hidden","rules":null,"key":"merchant","name":"merchant"},{"id":"callback","value":"https:\/\/alice-staging.jumia.co.ke\/checkout\/ipay\/confirm\/","label":"","type":"hidden","rules":null,"key":"callback","name":"callback"},{"id":"custemail","value":"","label":"","type":"hidden","rules":null,"key":"custemail","name":"custemail"},{"id":"tc","value":"","label":"I accept the Terms & Agreements","type":"checkbox","rules":{"required":{"message":"Required field","requiredValue":true}},"key":"tc","name":"tc"},{"id":"hashid","value":"","label":"","type":"hidden","rules":null,"key":"hashid","name":"hashid"},{"id":"mpesa","value":"","label":"M-PESA Transaction ID","type":"text","rules":{"required":true},"key":"mpesa","name":"mpesa"}],"name":"iPay_M-PESA"},"type":"submit-external","method":"post"}
