 ...
 *
 */
public class GetCreateAddressFormHelper extends BaseHelper {
    
    private static String TAG = GetCreateAddressFormHelper.class.getSimpleName();
    ...
    public Bundle generateRequestBundle(Bundle args) {
        Log.d(TAG, "REQUEST");
        String url = JumiaApplication.INSTANCE.getFormDataRegistry().get(EventType.GET_CREATE_ADDRESS_FORM_EVENT.action).getUrl();
        Bundle bundle = new Bundle();
        bundle.putString(Constants.BUNDLE_URL_KEY, url);
        bundle.putBoolean(Constants.BUNDLE_PRIORITY_KEY, HelperPriorityConfiguration.IS_PRIORITARY);
        bundle.putSerializable(Constants.BUNDLE_TYPE_KEY, RequestType.GET);
        bundle.putString(Constants.BUNDLE_MD5_KEY, Utils.uniqueMD5(Constants.BUNDLE_MD5_KEY));
        bundle.putSerializable(Constants.BUNDLE_EVENT_TYPE_KEY, EventType.GET_CREATE_ADDRESS_FORM_EVENT);
        return bundle;
    }
