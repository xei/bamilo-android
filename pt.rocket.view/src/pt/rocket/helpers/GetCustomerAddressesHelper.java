...
import pt.rocket.framework.objects.CustomerAddresses;
 ...
 *
 */
public class GetCustomerAddressesHelper extends BaseHelper {
    
    private static String TAG = GetCustomerAddressesHelper.class.getSimpleName();
    ...
    public Bundle generateRequestBundle(Bundle args) {
        ...
        bundle.putString(Constants.BUNDLE_URL_KEY, EventType.GET_CUSTOMER_ADDRESSES_EVENT.action);
    ...
    public Bundle parseResponseBundle(Bundle bundle, JSONObject jsonObject) {
        try {
            bundle.putParcelable(Constants.BUNDLE_RESPONSE_KEY, new CustomerAddresses(jsonObject));
            bundle.putSerializable(Constants.BUNDLE_EVENT_TYPE_KEY, EventType.GET_CUSTOMER_ADDRESSES_EVENT);
        } catch (Exception e) {
