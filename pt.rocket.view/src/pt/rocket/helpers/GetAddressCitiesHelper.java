 ...
 */
public class GetAddressCitiesHelper extends BaseHelper {
    
    private static String TAG = GetAddressCitiesHelper.class.getSimpleName();
    ...
    public Bundle generateRequestBundle(Bundle bundle) {
        ...
        // Get action
        String action = bundle.getString(Constants.BUNDLE_URL_KEY, EventType.GET_CITIES_EVENT.action);        
        // Validate action
        ...
        bundle.putSerializable(Constants.BUNDLE_EVENT_TYPE_KEY, EventType.GET_CITIES_EVENT);
