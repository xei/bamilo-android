...
public class ShoppingCartService {
	 ...
	 *            to be removed.
	 */
	public void handleShoppingCartEvent(RemoveItemFromShoppingCartEvent event) {

		Log.d(TAG, "removeItemFromShoppingCart: going to remove the item:" + event.value.getName());

		ContentValues values = new ContentValues();

		values.put("sku", event.value.getConfigSimpleSKU());
