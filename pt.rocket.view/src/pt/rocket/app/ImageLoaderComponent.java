...
public class ImageLoaderComponent extends ApplicationComponent {
    ...
    private void activateWeakDeviceMode(Context context){
        ...
        ImageLoaderConfiguration config = new ImageLoaderConfiguration.Builder(context)
                ...
                // 35% 208, 312
                // 50% 160, 240
                .memoryCacheExtraOptions((int) (WindowHelper.getWidth(context) * 0.60), (int) (WindowHelper.getHeight(context) * 0.60))
    ...
    private void activateNormalDeviceMode(Context context){
        ...
        ImageLoaderConfiguration config = new ImageLoaderConfiguration.Builder(context)
                .discCacheSize(16 * 1024 * 1024)
                .memoryCacheSize(4 * 1024 * 1024)
                .memoryCacheExtraOptions((int) (WindowHelper.getWidth(context) * 0.45), (int) (WindowHelper.getHeight(context) * 0.45))
                .denyCacheImageMultipleSizesInMemory()
                .defaultDisplayImageOptions(largeLoaderOptions)
                .build();
    ...
    private void activateHighDeviceMode(Context context){
        ...
        ImageLoaderConfiguration config = new ImageLoaderConfiguration.Builder(context)
                .discCacheSize(16 * 1024 * 1024)
                .memoryCacheSize(4 * 1024 * 1024)
                .memoryCacheExtraOptions((int) (WindowHelper.getWidth(context) * 0.90), (int) (WindowHelper.getHeight(context) * 0.90))
                .denyCacheImageMultipleSizesInMemory()
                .defaultDisplayImageOptions(largeLoaderOptions)
                .build();
