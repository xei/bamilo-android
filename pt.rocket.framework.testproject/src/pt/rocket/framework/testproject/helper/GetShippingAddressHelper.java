 ...
 * 
 */
public class GetShippingAddressHelper extends BaseHelper {

	private static String TAG = GetShippingAddressHelper.class.getSimpleName();
	...
	public Bundle generateRequestBundle(Bundle args) {
		...
		bundle.putSerializable(Constants.BUNDLE_EVENT_TYPE_KEY, EventType.GET_DEFAULT_BILLING_ADDRESS_EVENT);
		return bundle;
	}
	...
	public Bundle parseResponseBundle(Bundle bundle, JSONObject jsonObject) {
		...
		try {
			XMLObject responseRules = XMLUtils.xmlParser(mContext, R.xml.get_shipping_address_rules);
