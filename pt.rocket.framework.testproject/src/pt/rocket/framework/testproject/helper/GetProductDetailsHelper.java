 ...
 */
public class GetProductDetailsHelper extends BaseHelper {

	private static String TAG = GetProductDetailsHelper.class.getSimpleName();
	...
	public Bundle parseResponseBundle(Bundle bundle, JSONObject jsonObject) {
		...
		try {
			XMLObject responseRules = XMLUtils.xmlParser(mContext, R.xml.get_product_details_rules);
