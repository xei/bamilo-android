...
public class GetPollFormHelper extends BaseHelper {
	...
	public Bundle generateRequestBundle(Bundle args) {
		...
		bundle.putSerializable(Constants.BUNDLE_EVENT_TYPE_KEY, EventType.GET_POLL_FORM_FALLBACK_EVENT);
		return bundle;
	}
	...
	public Bundle parseResponseBundle(Bundle bundle, JSONObject jsonObject) {
		...
		try {
			XMLObject responseRules = XMLUtils.xmlParser(mContext, R.xml.get_poll_form_rules);
