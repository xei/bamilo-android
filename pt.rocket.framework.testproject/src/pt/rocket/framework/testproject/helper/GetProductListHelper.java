 ...
 */
public class GetProductListHelper extends BaseHelper {

	private static String TAG = GetProductListHelper.class.getSimpleName();
	...
	public Bundle generateRequestBundle(Bundle args) {
		...
		/**
		 * TODO: 
		 * Change product_url to the test product url
		 */
		bundle.putString(
				Constants.BUNDLE_URL_KEY, args.getString(BaseHelper.KEY_COUNTRY));
	...
	public Bundle parseResponseBundle(Bundle bundle, JSONObject jsonObject) {
		...
		try {
			XMLObject responseRules = XMLUtils.xmlParser(mContext, R.xml.get_product_list_rules);
