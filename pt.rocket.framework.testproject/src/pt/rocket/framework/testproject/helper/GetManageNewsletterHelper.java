 ...
 * 
 */
public class GetManageNewsletterHelper extends BaseHelper {

    private static String TAG = GetManageNewsletterHelper.class.getSimpleName();
    ...
    public Bundle parseResponseBundle(Bundle bundle, JSONObject jsonObject) {
        ...
        try {
            XMLObject responseRules = XMLUtils.xmlParser(mContext, R.xml.get_manage_newsletter_rules);
