...
public class GetMyOrderHelper extends BaseHelper {
    ...
    public Bundle generateRequestBundle(Bundle args) {
        ...
        bundle.putSerializable(Constants.BUNDLE_EVENT_TYPE_KEY, EventType.GET_MY_ORDER_EVENT);
        return bundle;
    }
    ...
    public Bundle parseResponseBundle(Bundle bundle, JSONObject jsonObject) {
        ...
        try {
            ...
            XMLObject responseRules = XMLUtils.xmlParser(mContext, R.xml.get_my_order_rules);
