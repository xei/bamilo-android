...
import com.rocket.framework.testshell.test.R.xml;
 ...
 * 
 */
public class GetPollHelper extends BaseHelper {
    
    public static final String CONTENT_VALUES = "contentValues";

    private static String TAG = GetPollHelper.class.getSimpleName();
    ...
    public Bundle parseResponseBundle(Bundle bundle, JSONObject jsonObject) {
        ...
        try {
            ...
            XMLObject responseRules = XMLUtils.xmlParser(mContext, R.xml.get_poll_rules);
