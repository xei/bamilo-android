 ...
 * 
 */
public class GetCartDataHelper extends BaseHelper {

    private static String TAG = GetCartDataHelper.class.getSimpleName();
    ...
    public Bundle parseResponseBundle(Bundle bundle, JSONObject jsonObject) {
        ...
        try {
            XMLObject responseRules = XMLUtils.xmlParser(mContext, R.xml.get_cart_data_rules);
