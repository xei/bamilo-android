 ...
 * 
 */
public class GetOrderSummaryHelper extends BaseHelper {

    private static String TAG = GetOrderSummaryHelper.class.getSimpleName();
    ...
    public Bundle parseResponseBundle(Bundle bundle, JSONObject jsonObject) {
        ...
        try {
            XMLObject responseRules = XMLUtils.xmlParser(mContext, R.xml.get_order_summary_rules);
