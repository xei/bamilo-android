 ...
 * 
 */
public class GetBillingAddressHelper extends BaseHelper {

    private static String TAG = GetBillingAddressHelper.class.getSimpleName();
    ...
    public Bundle parseResponseBundle(Bundle bundle, JSONObject jsonObject) {
        ...
        try {
            XMLObject responseRules = XMLUtils.xmlParser(mContext, R.xml.get_billing_address_rules);
