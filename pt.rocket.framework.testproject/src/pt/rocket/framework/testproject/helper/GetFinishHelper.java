 ...
 * 
 */
public class GetFinishHelper extends BaseHelper {
	
	public static final String CONTENT_VALUES = "contentValues";

	private static String TAG = GetFinishHelper.class.getSimpleName();
	...
	public Bundle parseResponseBundle(Bundle bundle, JSONObject jsonObject) {
		...
		try {
			...
			XMLObject responseRules = XMLUtils.xmlParser(mContext, R.xml.get_finish);
