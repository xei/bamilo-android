...
public class SetShippingMethodHelper extends BaseHelper {
    ...
    public Bundle generateRequestBundle(Bundle args) {
        ...
        bundle.putSerializable(Constants.BUNDLE_EVENT_TYPE_KEY, EventType.SET_SHIPPING_METHOD_EVENT);
        return bundle;
    }
    ...
    public Bundle parseResponseBundle(Bundle bundle, JSONObject jsonObject) {
        ...
        try {
            ...
            XMLObject responseRules = XMLUtils.xmlParser(mContext, R.xml.set_shipping_method_rules);
