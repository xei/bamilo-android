 ...
 * 
 */
public class SetBillingMethodHelper extends BaseHelper {
	
	public static final String CONTENT_VALUES = "contentValues";

	private static String TAG = SetBillingMethodHelper.class.getSimpleName();
	...
	public Bundle generateRequestBundle(Bundle args) {
		...
		bundle.putSerializable(Constants.BUNDLE_EVENT_TYPE_KEY, EventType.SET_BILLING_ADDRESS_EVENT);
		return bundle;
	}
	...
	public Bundle parseResponseBundle(Bundle bundle, JSONObject jsonObject) {
		...
		try {
			...
			XMLObject responseRules = XMLUtils.xmlParser(mContext, R.xml.set_billing_method_rules);
