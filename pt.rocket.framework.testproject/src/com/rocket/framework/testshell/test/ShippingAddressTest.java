...
import pt.rocket.framework.testproject.helper.GetShippingAddressHelper;
...
@SmallTest
public class ShippingAddressTest extends FrameworkServiceTests {
    private static String TAG = ShippingAddressTest.class.getSimpleName();
    protected boolean processed = false;
    protected boolean processed1 = false;
    
//public void testShippingAddressIC() throws Throwable {
//	test("https://alice-staging.jumia.co.ke");
//}
//
public void testShippingAddressKE() throws Throwable {
	test("https://alice-staging.jumia.co.ke");
}

//public void testShippingAddressMA() throws Throwable {
//	test("https://alice-staging.jumia.co.ke");
//}
//
//public void testShippingAddressNG() throws Throwable {
//	test("https://alice-staging.jumia.co.ke");
//}
//
//public void testShippingAddressEG() throws Throwable {
//	test("https://alice-staging.jumia.co.ke");
//}
//
//public void testShippingAddressUG() throws Throwable {
//	test("https://alice-staging.jumia.co.ke");
//}
...
public void test(String url){
    ...
    args.putString(BaseHelper.KEY_COUNTRY, url + "/mobapi/customer/shippingaddress/");
    sendRequest(args, new GetShippingAddressHelper(), new IResponseCallback() {
