...
public class CallToOrder extends FrameworkServiceTests {
    ...
    public void testCallToOrderKE() throws Throwable {
        ...
        args.putString(BaseHelper.KEY_COUNTRY, BaseHelper.BASE_URL_KE+"/main/getconfig/module/configurationml/key/phone_number/");
        sendRequest(args, new GetCallToOrderHelper(), new IResponseCallback() {
    ...
    public void testCallToOrderUG() throws Throwable {
        Log.i(TAG, "mService => " + mService);
        Bundle args = new Bundle();
        args.putString(BaseHelper.KEY_COUNTRY, BaseHelper.BASE_URL_UG+"/main/getconfig/module/configurationml/key/phone_number/");
        sendRequest(args, new GetCallToOrderHelper(), new IResponseCallback() {
