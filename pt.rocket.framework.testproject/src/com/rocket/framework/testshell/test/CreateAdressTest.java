...
public class CreateAdressTest extends FrameworkServiceTests {
	...
	public void testCreateAddressGH() throws Throwable {
		test(BaseHelper.BASE_URL_GH, RequestConstants.CREATE_ADDRESS_FK_REGION_GH, RequestConstants.CREATE_ADDRESS_FK_CITY_GH);
	}
