...
public class SearchSuggestionTest extends FrameworkServiceTests {
    ...
    public void testSearchSuggestionKE() throws Throwable {
        Log.i(TAG, "mService => " + mService);
        Bundle args = new Bundle();
        args.putString(BaseHelper.KEY_COUNTRY, "http://www.jumia.ci/mobapi/search/suggest/?q=sandal");
        sendRequest(args, new GetSearchSuggestionHelper(), new IResponseCallback() {
    ...
    public void testSearchSuggestionMA() throws Throwable {
        Log.i(TAG, "mService => " + mService);
        Bundle args = new Bundle();
        args.putString(BaseHelper.KEY_COUNTRY, "http://www.jumia.ci/mobapi/search/suggest/?q=ipad");
        sendRequest(args, new GetSearchSuggestionHelper(), new IResponseCallback() {
    ...
    public void testSearchSuggestionNG() throws Throwable {
        Log.i(TAG, "mService => " + mService);
        Bundle args = new Bundle();
        args.putString(BaseHelper.KEY_COUNTRY, "http://www.jumia.ci/mobapi/search/suggest/?q=asha");
        sendRequest(args, new GetSearchSuggestionHelper(), new IResponseCallback() {
    ...
    public void testSearchSuggestionEG() throws Throwable {
        Log.i(TAG, "mService => " + mService);
        Bundle args = new Bundle();
        args.putString(BaseHelper.KEY_COUNTRY, "http://www.jumia.ci/mobapi/search/suggest/?q=sneaker");
        sendRequest(args, new GetSearchSuggestionHelper(), new IResponseCallback() {
