...
@SmallTest
public class CampaignTest extends FrameworkServiceTests {
    private static String TAG = CampaignTest.class.getSimpleName();
...
public void testCampaignGH() throws Throwable {
...
public void test(String url){
    ...
    sendRequest(args, new GetCampaignHelper(), new IResponseCallback() {
