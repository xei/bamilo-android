...
public void testShoppingCartChangeItemQuantityIC() throws Throwable {
        ...
        args.putString(BaseHelper.KEY_COUNTRY, BaseHelper.BASE_URL_CI+"/order/cartchange/");
...
public void testShoppingCartChangeItemQuantityKE() throws Throwable {
    ...
    Log.i(TAG, "mService => " + mService);
    Bundle args = new Bundle();
    args.putString(BaseHelper.KEY_COUNTRY, BaseHelper.BASE_URL_KE+"/order/cartchange/");
    ContentValues contentValues2 = new ContentValues();
...
public void testShoppingCartChangeItemQuantityMA() throws Throwable {
    ...
    Log.i(TAG, "mService => " + mService);
    Bundle args = new Bundle();
    args.putString(BaseHelper.KEY_COUNTRY, BaseHelper.BASE_URL_MA+"/order/cartchange/");
    ContentValues contentValues2 = new ContentValues();
...
public void testShoppingCartChangeItemQuantityNG() throws Throwable {
    ...
    Log.i(TAG, "mService => " + mService);
    Bundle args = new Bundle();
    args.putString(BaseHelper.KEY_COUNTRY, BaseHelper.BASE_URL_NG+"/order/cartchange/");
    ContentValues contentValues2 = new ContentValues();
...
public void testShoppingCartChangeItemQuantityEG() throws Throwable {
    ...
    Log.i(TAG, "mService => " + mService);
    Bundle args = new Bundle();
    args.putString(BaseHelper.KEY_COUNTRY, BaseHelper.BASE_URL_EG+"/order/cartchange/");
    ContentValues contentValues2 = new ContentValues();
...
public void testShoppingCartChangeItemQuantityUG() throws Throwable {
    ...
    Log.i(TAG, "mService => " + mService);
    Bundle args = new Bundle();
    args.putString(BaseHelper.KEY_COUNTRY, BaseHelper.BASE_URL_UG+"/order/cartchange/");
    ContentValues contentValues2 = new ContentValues();
