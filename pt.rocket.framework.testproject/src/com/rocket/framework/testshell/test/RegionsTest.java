...
@SmallTest
public class RegionsTest extends FrameworkServiceTests {
    private static String TAG = RegionsTest.class.getSimpleName();
    protected boolean processed = false;
    protected boolean processed1 = false;
    
public void testRegionsIC() throws Throwable {
	test("https://alice-staging.jumia.ci");
}
...
public void testRegionsMA() throws Throwable {
	test("https://alice-staging.jumia.ma");
}

public void testRegionsNG() throws Throwable {
	test("https://alice-staging.jumia.com.ng");
}
...
public void test(String url){
    ...
    args.putString(BaseHelper.KEY_COUNTRY, url + "/mobapi/customer/address/regions/");
