...
import pt.rocket.framework.testproject.helper.GetRegisterFormHelper;
...
public class RegisterFormTest extends FrameworkServiceTests {
	private static String TAG = RegisterFormTest.class.getSimpleName();
	...
	public void testRegisterFormGH() throws Throwable {
	...
	public void test(String url) {
		...
		args.putString(BaseHelper.KEY_COUNTRY, url + "/forms/register/");
