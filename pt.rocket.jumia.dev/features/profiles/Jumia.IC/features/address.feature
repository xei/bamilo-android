...
#    Then I wait for progress
    ...
    @address_homepage_add_success_CL
   ...
   And I wait for 5 seconds 
    ...
    Then I enter "fake test " into "New Second Addressline1 Box"
     And I wait for 5 seconds
    Then I enter "street" into "New Second Addressline1 Box"
   ...
   Scenario: add and remove address on my account
    ...
    And I wait for 5 seconds
    Then I clear "New Second Addressline1 Box"
    Then I enter "street to " into "New Second Addressline1 Box"
     And I wait for 5 seconds
    Then I enter "delete" into "New Second Addressline1 Box"
    And I press "Ok Button"
    And I wait for 5 seconds
    And I press "Remove Address Button"
    And I wait for 3 seconds
