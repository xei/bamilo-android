...
//import com.mobile.framework.utils.Direction;
//import com.mobile.framework.utils.EventType;
//import com.mobile.framework.utils.ProductSort;
...
//        
//        parentFragment = (CatalogFragment) getBaseActivity().getSupportFragmentManager().findFragmentByTag(FragmentType.CATALOG.toString());
//
...
//        this.linearLayoutLm = (LinearLayout) view.findViewById(R.id.catalog_loading_more);
...
//                else triggerContentEventNoLoading(new GetProductsHelper(), bundle, responseCallback);
//            } else {
...
//                            RelatedItemsTableHelper.insertRelatedItemsAndClear(productsPage.getProductsList());
...
//        getBaseActivity().onSwitchFragment(FragmentType.CATALOG, getArguments(), FragmentController.ADD_TO_BACK_STACK);
//    }
//    
//    /**
