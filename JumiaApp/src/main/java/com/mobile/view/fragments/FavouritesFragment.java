...
//import com.mobile.newFramework.objects.product.NewProductVariation;
//import com.mobile.newFramework.objects.product.pojo.NewProductSimple;
...
//
//    protected ArrayList<NewProductVariation> mAddableToCartList;
//
...
//            NewProductVariation addableToCart = mAddableToCartList.get(position);
...
////        try {
////            int position = Integer.parseInt(view.getTag().toString());
////            NewProductAddableToCart addableToCart = mAddableToCartList.get(position);
////            // Validate variation
...
//
//            String[] categoriesList = addableToCart.getCategoriesList();
//            if (null != addableToCart && categoriesList.length> 0){
...
//        // Create new array
//        ArrayList<NewProductVariation> array = new ArrayList<>();
...
//
//    protected void showVariantsDialog(NewProductVariation addableToCart) {
...
//    }
//
//    protected ArrayList<String> createSimpleVariants(NewProductVariation addableToCart, ArrayList<String> mSimpleVariantsAvailable) {
...
//        for (NewProductSimple simple : addableToCart.getSimples()) {
