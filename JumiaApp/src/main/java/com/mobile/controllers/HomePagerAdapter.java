...
//import com.mobile.view.fragments.old.HomePageFragmentOld;
//
...
//        bundle.putParcelable(HomePageFragmentOld.HOME_PAGE_KEY, this.mHomePages.get(position));
//        return HomePageFragmentOld.getInstance(bundle);
//    }
//
//    /*
//     * (non-Javadoc)
