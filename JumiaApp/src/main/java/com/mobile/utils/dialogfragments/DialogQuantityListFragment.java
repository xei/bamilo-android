 ...
 *
 */
public class DialogQuantityListFragment extends BottomSheet implements OnItemClickListener, OnClickListener {

    private final static String TAG = DialogQuantityListFragment.class.getSimpleName();
     ...
     * Create new instance
     */
    public static DialogQuantityListFragment newInstance(Context context, String title, ProductMultiple product, OnDialogListListener listListener) {
     ...
     */
    public static DialogQuantityListFragment newInstance(Context context, String title, CampaignItem product, OnDialogListListener listListener) {
        Print.d(TAG, "NEW INSTANCE");
        DialogQuantityListFragment dialogListFragment = new DialogQuantityListFragment();
        dialogListFragment.mContext = context;
        dialogListFragment.mListener = listListener;
