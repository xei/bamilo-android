 ...
 */
public abstract class ReturnOrderViewHolder { //extends RecyclerView.ViewHolder {
     ...
     */
    public ReturnOrderViewHolder(Context context, View itemView, View.OnClickListener onClickListener) {
        //super(itemView);
