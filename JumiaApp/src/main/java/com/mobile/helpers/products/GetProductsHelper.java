...
//        bundle.putString(
//                Constants.BUNDLE_URL_KEY,
//                getRequestURI(args.getString(PRODUCT_URL), args.getString(SEARCH_QUERY),
//                        args.getInt(PAGE_NUMBER), args.getInt(TOTAL_COUNT), args.getInt(SORT),
//                        args.getInt(DIRECTION), (ContentValues) args.getParcelable(FILTERS)));
...
//    }
//
//    private String getRequestURI(String productUrl, String searchQuery, int pageNumber,
//            int totalCount, int sort, int direction, ContentValues filters) {
//        Uri productsUri;
