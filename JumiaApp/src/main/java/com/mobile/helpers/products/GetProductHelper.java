...
public class GetProductHelper extends SuperBaseHelper {
    ...
    public void onRequest(RequestBundle requestBundle) {
        new GetProductDetail(JumiaApplication.INSTANCE.getApplicationContext(), requestBundle, this).execute();
    }
    ...
    public void onRequestComplete(BaseResponse baseResponse) {
        ...
        //
        CompleteProduct product = (CompleteProduct) baseResponse.metadata.getData();
        //
