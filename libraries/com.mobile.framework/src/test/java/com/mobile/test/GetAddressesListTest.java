...
public class GetAddressesListTest extends BaseTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        requestBundle = new RequestBundle.Builder()
                .setUrl("https://www.jumia.com.ng/mobapi/v1.7/customer/address/list/")
                .setCache(EventType.GET_CUSTOMER_ADDRESSES_EVENT.cacheTime)
                .setData(data)
                .build();
    }
