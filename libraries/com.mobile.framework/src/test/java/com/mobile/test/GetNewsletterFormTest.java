...
public class GetNewsletterFormTest extends BaseTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        requestBundle = new RequestBundle.Builder()
                .setUrl("https://www.jumia.ci/mobapi/v1.7/forms/managenewsletters/")
                .setCache(EventType.GET_NEWSLETTERS_FORM_EVENT.cacheTime)
                .build();
    }
