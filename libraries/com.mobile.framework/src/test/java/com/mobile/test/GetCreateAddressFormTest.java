...
public class GetCreateAddressFormTest extends BaseTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        requestBundle = new RequestBundle.Builder()
                .setUrl("https://www.jumia.ci/mobapi/v1.7/forms/addresscreate/")
                .setCache(EventType.GET_CREATE_ADDRESS_FORM_EVENT.cacheTime)
                .build();
    }
