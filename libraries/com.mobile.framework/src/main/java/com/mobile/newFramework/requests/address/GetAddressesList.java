...
public class GetAddressesList extends BaseRequest<Addresses> {

    public GetAddressesList(Context context, RequestBundle requestBundle, AigResponseCallback requester) {
