...
public class GetProductDetail extends BaseRequest {

    public GetProductDetail(Context context, BaseRequestBundle requestBundle, AigResponseCallback requester) {
