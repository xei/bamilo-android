...
public class GetProductBundle extends BaseRequest<BaseResponse> {

    public GetProductBundle(Context context, RequestBundle requestBundle, AigResponseCallback requester) {
