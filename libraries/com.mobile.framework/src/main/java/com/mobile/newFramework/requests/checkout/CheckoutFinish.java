...
public class CheckoutFinish extends BaseRequest<SuperCheckoutFinish> {

    public CheckoutFinish(Context context, RequestBundle requestBundle, AigResponseCallback requester) {
