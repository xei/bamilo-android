...
public class SetDefaultBillingAddress extends BaseRequest<SuperCustomerNewsletterSubscription> {

    public SetDefaultBillingAddress(Context context, RequestBundle requestBundle, AigResponseCallback requester) {
