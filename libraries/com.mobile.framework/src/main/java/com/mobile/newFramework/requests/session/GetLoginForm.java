...
public class GetLoginForm extends BaseRequest<SuperForm> {

    EventType type = EventType.GET_LOGIN_FORM_EVENT;

    public GetLoginForm(Context context, RequestBundle requestBundle, AigResponseCallback requester) {
