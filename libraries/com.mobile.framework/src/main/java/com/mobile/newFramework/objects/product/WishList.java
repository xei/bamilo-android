 ...
 */
public class WishList extends ArrayList<NewProductAddableToCart> implements IJSONSerializable {
    ...
    public boolean initialize(JSONObject jsonObject) throws JSONException {
        ...
        if (size > 0) {
            for (int i = 0; i < size; i++) {
                ...
                NewProductAddableToCart product = new NewProductAddableToCart();
