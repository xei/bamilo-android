...
//
//            String offerPriceJSON = dataObject.optString(RestConstants.JSON_OFFERS_MIN_PRICE_TAG);
//
...
//            minPriceOfferConverted = dataObject.optDouble(RestConstants.JSON_OFFERS_MIN_PRICE_CONVERTED_TAG, 0);
//            totalOffers = dataObject.optInt(RestConstants.JSON_TOTAL_TAG, 0);
//
//            // Offers
//            JSONArray offersArray = dataObject.optJSONArray(RestConstants.JSON_DATA_TAG);
//
