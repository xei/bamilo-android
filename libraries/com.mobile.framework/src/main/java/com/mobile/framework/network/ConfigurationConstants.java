...
public class ConfigurationConstants {
	...
	public final static boolean FORCE_CACHE = false;   
	...
	public static final int CACHE_CONTROL_MAX_AGE_RESTRICTION = 24 * 60 * 60;
    
    
    /**
     * ---- Timeout defining variables ----
     */
...
//    public static final int TIMEOUT = 10000;
	...
	/**
	 * ---- Request compression activated : GZIP ----
	 */
