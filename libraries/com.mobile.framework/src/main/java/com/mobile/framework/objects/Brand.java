...
//
//            JSONObject innerObject = jsonObject.getJSONObject(JsonConstants.JSON_INNER_OBJECT_TAG);
//            url = innerObject.getString(JsonConstants.JSON_URL_TAG);
//            name = innerObject.getString(JsonConstants.JSON_NAME_TAG);
...
//
//
//            JSONObject imageObject = innerObject.optJSONObject(JsonConstants.JSON_IMAGE_TAG);
//
//            if (imageObject != null) {
...
//            jsonObject.put(JsonConstants.JSON_IMAGE_TAG, image.toJSON());
//
//        } catch (JSONException e) {
//            e.printStackTrace();
//            return null;
