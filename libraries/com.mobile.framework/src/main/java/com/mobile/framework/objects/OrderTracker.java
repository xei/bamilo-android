...
//
//        order_id = jsonObject.optString(JsonConstants.JSON_ORDER_ID_TAG);
//        creation_date = jsonObject.optString(JsonConstants.JSON_ORDER_CREATION_DATE_TAG);
//        payment_method = jsonObject.optString(JsonConstants.JSON_ORDER_PAYMENT_METHOD_TAG);
//        last_order_update = jsonObject.optString(JsonConstants.JSON_ORDER_LAST_UPDATE_TAG);
//		JSONObject items = jsonObject.optJSONObject(JsonConstants.JSON_ORDER_ITEM_COLLECTION_TAG);
//
