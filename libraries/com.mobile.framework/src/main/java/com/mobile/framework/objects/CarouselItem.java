...
//        try {
//            id = jsonObject.getString(JsonConstants.JSON_ID_TAG);
//
//            JSONObject dataObject = jsonObject.getJSONObject(JsonConstants.JSON_DATA_TAG);
//
//            description = dataObject.getString(JsonConstants.JSON_DESCRIPTION_TAG);
//            url = dataObject.getString(JsonConstants.JSON_URL_TAG);
...
//        try {
//
//            jsonObject.put(JsonConstants.JSON_ID_TAG, id);
//
//            JSONObject dataObject = new JSONObject();
//            dataObject.put(JsonConstants.JSON_DESCRIPTION_TAG, description);
//            dataObject.put(JsonConstants.JSON_URL_TAG, url);
//
//            jsonObject.put(JsonConstants.JSON_DATA_TAG, dataObject);
//        } catch(JSONException e) {
//            e.printStackTrace();
//        }
//        return jsonObject;
