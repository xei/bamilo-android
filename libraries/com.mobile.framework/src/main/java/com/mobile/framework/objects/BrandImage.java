...
//		this.url = jsonObject.optString(JsonConstants.JSON_URL_TAG);
//		this.width = jsonObject.optString(JsonConstants.JSON_WIDTH_TAG);
//		this.height = jsonObject.optString(JsonConstants.JSON_HEIGHT_TAG);
//		this.format = jsonObject.optString(JsonConstants.JSON_FORMAT_TAG);
//
//		return true;
//	}
//
...
//			jsonObject.put(JsonConstants.JSON_WIDTH_TAG, width);
//			jsonObject.put(JsonConstants.JSON_HEIGHT_TAG, height);
//			jsonObject.put(JsonConstants.JSON_FORMAT_TAG, format);
//
