...
//        totalProducts = metadataObject.optInt(JsonConstants.JSON_PRODUCT_COUNT_TAG, 0);
//        mPageName = metadataObject.optString(JsonConstants.JSON_CATALOG_NAME_TAG, "");
//        mCategoryId = metadataObject.optString(JsonConstants.JSON_CATALOG_IDS_TAG, "");
//
//        JSONArray productObjectArray = metadataObject.getJSONArray(JsonConstants.JSON_RESULTS_TAG);
//
//        // Get products
...
//
//        // Get category filter
//        if (!metadataObject.isNull(JsonConstants.JSON_CATEGORIES_TAG)) {
//            // Validate array
//            JSONArray categoriesArray = metadataObject.optJSONArray(JsonConstants.JSON_CATEGORIES_TAG);
...
//        if(!metadataObject.isNull(JsonConstants.JSON_FILTERS_TAG)){
//            JSONArray jsonArray = metadataObject.getJSONArray(JsonConstants.JSON_FILTERS_TAG);
...
//            categoryArray = parentObject.optJSONArray(JsonConstants.JSON_CHILDREN_TAG);
//        }
