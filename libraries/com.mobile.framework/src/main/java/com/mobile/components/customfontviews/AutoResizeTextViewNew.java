...
public class AutoResizeTextViewNew extends TextView {
        ...
        public AutoResizeTextViewNew(final Context context)
        {
            this(context,null,0);
        }

        public AutoResizeTextViewNew(final Context context, final AttributeSet attrs)
        {
            this(context,attrs,0);
        }

        public AutoResizeTextViewNew(final Context context, final AttributeSet attrs, final int defStyle)
        {
