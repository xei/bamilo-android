...
import com.bamilo.android.framework.components.widget.likebutton.utils.CircleView;
import com.bamilo.android.framework.components.widget.likebutton.utils.DotsView;
import com.bamilo.android.framework.components.widget.likebutton.utils.Utils;
...
public class SparkButton extends FrameLayout implements View.OnClickListener {
    ...
    void init() {
        ...
        imageView = (AppCompatImageView) findViewById(R.id.ivImage);
    ...
    private void getStuffFromXML(AttributeSet attr) {
        ...
        imageSize = a.getDimensionPixelOffset(R.styleable.sparkbutton_sparkbutton_iconSize, Utils
                .dpToPx(getContext(), 50));
