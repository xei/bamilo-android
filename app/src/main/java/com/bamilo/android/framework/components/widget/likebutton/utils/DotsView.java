package com.bamilo.android.framework.components.widget.likebutton.utils;
...
public class DotsView extends View {
    ...
    private void updateOuterDotsPosition() {
        ...
        if (currentProgress < 0.7) {
            ...
            this.currentDotSize1 = (float) Utils
                    .mapValueFromRangeToRange(currentProgress, 0.7f, 1f, maxDotSize, 0);
        }
    }

    private void updateDotsPaints() {
        if (currentProgress < 0.5f) {
            float progress = (float) Utils
                    .mapValueFromRangeToRange(currentProgress, 0f, 0.5f, 0, 1f);
            ...
            float progress = (float) Utils
                    .mapValueFromRangeToRange(currentProgress, 0.5f, 1f, 0, 1f);
