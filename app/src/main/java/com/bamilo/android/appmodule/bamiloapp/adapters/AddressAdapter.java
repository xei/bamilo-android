...
public class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.AddressViewHolder> implements IResponseCallback {
    ...
    public class AddressViewHolder extends RecyclerView.ViewHolder {
        ...
        public AddressViewHolder(View view) {
            super(view);
            name = view.findViewById(R.id.checkout_address_item_name);
            street = view.findViewById(R.id.checkout_address_item_street);
            phone = view.findViewById(R.id.checkout_address_item_phone);
            checkBox = view.findViewById(R.id.checkout_address_item_radio_btn);
            editButton = view.findViewById(R.id.checkout_address_item_btn_edit);
            editButton_Rl = view.findViewById(R.id.checkout_address_item_btn_edit_rl);
            deleteButton = view.findViewById(R.id.checkout_address_item_btn_delete);
            root = view.findViewById(R.id.checkout_address_item_content);
            vertical = view.findViewById(R.id.vertical_separator);
