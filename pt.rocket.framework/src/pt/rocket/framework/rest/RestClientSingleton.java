...
//                TrackerManager.sendTrackingError(e);
            ...
            case CACHE_HIT:
                Log.d(TAG, "A response was generated from the cache with no requests " + "sent upstream");
                break;
            case CACHE_MODULE_RESPONSE:
                Log.d(TAG, "The response was generated directly by the caching module");
                break;
            case CACHE_MISS:
                Log.d(TAG, "The response came from an upstream server");
                break;
            case VALIDATED:
                Log.d(TAG, "The response was generated from the cache after validating " + "the entry with the origin server");
                break;
            }
	...
	private void trackError(Context mContext, Exception e, URI uri, ErrorCode errorCode,
    ...
    private static void setAuthentication(DefaultHttpClient httpClient) {
        ...
        if (RestContract.USE_AUTHENTICATION) {
            httpClient.getCredentialsProvider().setCredentials(new AuthScope(RestContract.REQUEST_HOST, AuthScope.ANY_PORT),
