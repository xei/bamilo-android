...
//    public static String GTM_INSTALL_APP = "install"; 
    ...
    public static String GTM_AUTOLOGIN = "autoLogin";
    public static String GTM_AUTOLOGIN_FAILED = "autoLoginFailed";
    ...
    public static class GTMKeys {
        ...
        public static String TRANSACTIONAFFILIATION = "transactionAffiliation";
    ...
    public static class GTMValues {
        ...
        public static String PRICEUP ="Price up";
        public static String PRICEDOWN ="Price down";
        public static String NAME ="Name";
