...
public class GTMManager {
    ...
    private static ArrayList<Map<Object, Object>> pendingEvents = new ArrayList<Map<Object, Object>>();
...
//    }
    ...
    public void gtmTrackLogout() {
        ...
        Map<Object, Object> message = DataLayer.mapOf(EVENT_TYPE, GTMEvents.GTM_LOGOUT, GTMEvents.GTMKeys.LOGOUTLOCATION, GTMEvents.GTMValues.SIDEMENU);
        sendEvent(message);

    }

    public void gtmForgotPassword() {
        Log.i(TAG, " GTM TRACKING -> gtmForgotPassword");

        Map<Object, Object> message = DataLayer.mapOf(EVENT_TYPE, GTMEvents.GTM_LOGIN, GTMEvents.GTMKeys.PASSWORD_FORGOTTEN, "");
        sendEvent(message);
    ...
    public void gtmtrackContactButtonClick(String contactType, String sku, String price, int customerId, String currency) {
        Log.i(TAG, " GTM TRACKING -> gtmtrackContactButtonClick");
        Map<Object, Object> message = DataLayer.mapOf(EVENT_TYPE, GTMEvents.GTM_CONTACT_BUTTON, GTMEvents.GTMKeys.CONTACT_TYPE, contactType,
                GTMEvents.GTMKeys.PRODUCTSKU, sku, GTMEvents.GTMKeys.PRODUCTPRICE, price, GTMEvents.GTMKeys.CUSTOMERID, customerId, GTMEvents.GTMKeys.CURRENCY,
                currency);
        sendEvent(message);
    ...
    private void processPendingEvents() {
        ...
        try {
            if (pendingEvents != null) {
                ...
                for (Map<Object, Object> event : pendingEvents) {
