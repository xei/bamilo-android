...
package pt.rocket.components.icsspinner;
...
public class IcsSpinner extends IcsAbsSpinner implements OnClickListener {
    ...
    public IcsSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.actionCustomSpinnerDropDownStyle);
    }
    ...
    public IcsSpinner(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CustomSpinner, defStyle, 0);

        DropdownPopup popup = new DropdownPopup(context, attrs, defStyle);

        mDropDownWidth = a.getLayoutDimension(R.styleable.CustomSpinner_android_dropDownWidth, ViewGroup.LayoutParams.WRAP_CONTENT);
        popup.setBackgroundDrawable(a.getDrawable(R.styleable.CustomSpinner_android_popupBackground));
        final int verticalOffset = a.getDimensionPixelOffset(R.styleable.CustomSpinner_android_dropDownVerticalOffset, 0);
        if (verticalOffset != 0) {
            popup.setVerticalOffset(verticalOffset);
        }

        final int horizontalOffset = a.getDimensionPixelOffset(R.styleable.CustomSpinner_android_dropDownHorizontalOffset, 0);
        ...
        mGravity = a.getInt(R.styleable.CustomSpinner_android_gravity, Gravity.CENTER);

        mPopup.setPromptText(a.getString(R.styleable.CustomSpinner_android_prompt));
